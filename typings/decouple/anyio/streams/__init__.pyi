...
from typing import Any, TypeAlias, TypeVar, TypeVarTuple, Unpack, override
...
class TLSConnectable(ByteStreamConnectable):
    ...
    """
    def __init__(self, connectable: AnyByteStreamConnectable, *, hostname: str | None = ..., ssl_context: ssl.SSLContext | None = ..., standard_compatible: bool = ...) -> None:
        ...
