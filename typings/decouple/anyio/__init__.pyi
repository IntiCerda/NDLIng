...
from ._core._eventloop import get_async_backend, get_cancelled_exc_class, run as run_eventloop, threadlocals
...
def run(func: Callable[[Unpack[PosArgsT]], Awaitable[T_Retval]], *args: Unpack[PosArgsT], token: EventLoopToken | None = ...) -> T_Retval:
    """
...
def run_sync(func: Callable[[Unpack[PosArgsT]], T_Retval], *args: Unpack[PosArgsT], token: EventLoopToken | None = ...) -> T_Retval:
    """
