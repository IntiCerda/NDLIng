...
from dns.quic._common import AsyncQuicConnection, AsyncQuicManager, BaseQuicStream, QUIC_MAX_DATAGRAM, UnexpectedEOF
...
class TrioQuicManager(AsyncQuicManager):
    def __init__(self, nursery, conf=..., verify_mode=..., server_name=..., h3=...) -> None:
        ...
    
    def connect(self, address, port=..., source=..., source_port=..., want_session_ticket=...):
        ...
