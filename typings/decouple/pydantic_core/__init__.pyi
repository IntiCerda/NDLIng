...
class SchemaValidator:
    ...
    def validate_python(self, input: Any, *, strict: bool | None = ..., extra: ExtraBehavior | None = ..., from_attributes: bool | None = ..., context: Any | None = ..., self_instance: Any | None = ..., allow_partial: bool | Literal['off', 'on', 'trailing-strings'] = ..., by_alias: bool | None = ..., by_name: bool | None = ...) -> Any:
        """
    ...
    def isinstance_python(self, input: Any, *, strict: bool | None = ..., extra: ExtraBehavior | None = ..., from_attributes: bool | None = ..., context: Any | None = ..., self_instance: Any | None = ..., by_alias: bool | None = ..., by_name: bool | None = ...) -> bool:
        """
    ...
    def validate_json(self, input: str | bytes | bytearray, *, strict: bool | None = ..., extra: ExtraBehavior | None = ..., context: Any | None = ..., self_instance: Any | None = ..., allow_partial: bool | Literal['off', 'on', 'trailing-strings'] = ..., by_alias: bool | None = ..., by_name: bool | None = ...) -> Any:
        """
    ...
    def validate_strings(self, input: _StringInput, *, strict: bool | None = ..., extra: ExtraBehavior | None = ..., context: Any | None = ..., allow_partial: bool | Literal['off', 'on', 'trailing-strings'] = ..., by_alias: bool | None = ..., by_name: bool | None = ...) -> Any:
        """
    ...
    def validate_assignment(self, obj: Any, field_name: str, field_value: Any, *, strict: bool | None = ..., extra: ExtraBehavior | None = ..., from_attributes: bool | None = ..., context: Any | None = ..., by_alias: bool | None = ..., by_name: bool | None = ...) -> dict[str, Any] | tuple[dict[str, Any], dict[str, Any] | None, set[str]]:
        """
...
class SchemaSerializer:
    ...
    def to_python(self, value: Any, *, mode: str | None = ..., include: _IncEx | None = ..., exclude: _IncEx | None = ..., by_alias: bool | None = ..., exclude_unset: bool = ..., exclude_defaults: bool = ..., exclude_none: bool = ..., exclude_computed_fields: bool = ..., round_trip: bool = ..., warnings: bool | Literal['none', 'warn', 'error'] = ..., fallback: Callable[[Any], Any] | None = ..., serialize_as_any: bool = ..., context: Any | None = ...) -> Any:
        """
...
def to_json(value: Any, *, indent: int | None = ..., ensure_ascii: bool = ..., include: _IncEx | None = ..., exclude: _IncEx | None = ..., by_alias: bool = ..., exclude_none: bool = ..., round_trip: bool = ..., timedelta_mode: Literal['iso8601', 'float'] = ..., temporal_mode: Literal['iso8601', 'seconds', 'milliseconds'] = ..., bytes_mode: Literal['utf8', 'base64', 'hex'] = ..., inf_nan_mode: Literal['null', 'constants', 'strings'] = ..., serialize_unknown: bool = ..., fallback: Callable[[Any], Any] | None = ..., serialize_as_any: bool = ..., context: Any | None = ...) -> bytes:
    """
    Serialize a Python object to JSON including transforming and filtering data.
...
def to_jsonable_python(value: Any, *, include: _IncEx | None = ..., exclude: _IncEx | None = ..., by_alias: bool = ..., exclude_none: bool = ..., round_trip: bool = ..., timedelta_mode: Literal['iso8601', 'float'] = ..., temporal_mode: Literal['iso8601', 'seconds', 'milliseconds'] = ..., bytes_mode: Literal['utf8', 'base64', 'hex'] = ..., inf_nan_mode: Literal['null', 'constants', 'strings'] = ..., serialize_unknown: bool = ..., fallback: Callable[[Any], Any] | None = ..., serialize_as_any: bool = ..., context: Any | None = ...) -> Any:
    """
